...
<div class="the-box">
            ...
            {!!Form::open(['route' => ['transporte.asignar'], 'method' => 'POST'])!!}
							 ...
							 <div class="col-sm-4 col-md-4 col-lg-4">
								{!! Form::label('kminicial', 'Kilometraje Inicial:') !!}
								<input type="text" name="kminicial" class="form-control" value='' placeholder='50785'>
							</div>
							<div class="col-sm-4 col-md-4 col-lg-4">
								{!! Form::label('kmfinal', 'Kilometraje Final:') !!}
								<input type="text" name="kminicial" value='' class="form-control" placeholder='51785'>
							</div>
							<div class="col-sm-4 col-md-4 col-lg-4">
								{!! Form::label('factura', 'Factura:') !!}
								<input type="text" name="kminicial" value='' class="form-control" placeholder='786'>
							</div>
							</div>
							
							 
							<div class="form-group">
								{!! Form::label('vales', 'Vales de Combustibles:') !!}
								<div class="input_fields_wrap">
								
									<div><input type="text" name="mytext[]" value='17885522' disabled></div>
								</div>
								</div>
